...
``` shell
$ qctool dicom --root_folder [folder with dicoms] --report_folder [dicom report folderpath] (--loris) (--loris_folder)
```
...
`--loris_folder` is the folder where the dcm files are reorganized for LORIS pipeline
