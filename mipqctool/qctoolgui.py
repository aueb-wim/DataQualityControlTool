...
class CsvTab(tk.Frame):
    ...
    def __init(self):
        ...
        self.m_seperator = ttk.Separator(self.tblabelframe, orient=tk.HORIZONTAL)
        self.m_metadata_label = tk.Label(self.tblabelframe,
                                         text='Metadata (Schema) file:')
        self.m_metaname_label = tk.Label(self.tblabelframe, text='Not selected',
                                         bg='white', pady=4, width=50)
        self.m_metaload_button = tk.Button(self.tblabelframe, text='Select File',
                                           command=self.setmetadatafile)

        # Infer section
        self.i_categories_label = tk.Label(self.tblabelframe, text='Maximum Category Levels:')
        self.i_sample_rows_label = tk.Label(self.tblabelframe, text='Sample Rows:')
        self.i_categories_entry = tk.Entry(self.tblabelframe, width=10, 
        ...
        self.i_sample_rows_entry = tk.Entry(self.tblabelframe, width=10,
        ...
        self.i_save_button = tk.Button(self.tblabelframe, text='Save Schema',
                                       state='disabled', command=self.save_schema)

        # No metadata file checkbox
        self.i_cbutton = tk.Checkbutton(self.tblabelframe,
                                        text='Infer schema',
                                        variable=self.infer,
    ...
    def __packing(self):
        ...
        self.m_metadata_label.grid(row=2, column=0, padx=2, sticky='e')
        self.m_metaload_button.grid(row=2, column=2, sticky='w')
        self.m_metaname_label.grid(row=2, column=1, pady=2, padx=2)
        self.m_metaload_button.grid(row=2, column=2)
        self.m_seperator.grid(row=3, column=0, columnspan=3, sticky='ew', pady=2)

        # infer section
        self.i_categories_label.grid(row=4, column=0, sticky='e')
        self.i_categories_entry.grid(row=4, column=1, sticky='w')
        self.i_sample_rows_label.grid(row=5, column=0, sticky='e')
        self.i_sample_rows_entry.grid(row=5, column=1, sticky='w')
        self.i_cbutton.grid(row=4, column=2, sticky='w')
        self.i_save_button.grid(row=5, column=2, sticky='w')
